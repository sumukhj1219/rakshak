...
export function FeaturesSectionDemo() {
  const features = [
    {
      title: "Track military camps effectively",
      description:
        "Only owner can manage everything inside a camp",
      skeleton: <SkeletonOne />,
      className:
        "col-span-1 lg:col-span-4 border-b lg:border-r dark:border-neutral-800",
    },
    {
      title: "Protecting our nation using Blockchain X Ai",
      description:
        "Taking initiative and building India's first blockchain defence system.",
    ...
    (<div className="relative flex py-8 px-2 gap-10 ">
      <div
        ...
        <div className="flex flex-1 flex-col space-y-2 w-full ">
          {/* TODO */}
          <Image
            src="https://images.unsplash.com/photo-1516949912689-7275b3066ef5?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="header"
            width={1000}
            height={1000}
