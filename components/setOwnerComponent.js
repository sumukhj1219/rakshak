...
const SetOwnerComponent = () => {
    const [loading, setLoading] = useState(false);
    const [address, setAddress] = useState("");
    const [error, setError] = useState(null);
    const { transferOwnership } = useRakshakContext();
            ...
            <Dialog>
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ⚠️ This action cannot be undone. This will permanently change the ownership of the contract.
                        </DialogDescription>
                    </DialogHeader>
                </DialogContent>
            </Dialog>
...
export default SetOwnerComponent;
